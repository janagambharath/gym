import{k as o,a as d,e as r,C as c,J as m,D as e,i as v,n as l}from"./index-B7qIMgpI.js";const b={async mount(s){const i=await o("/api/member/v1/home"),n=i.ok?i.data:{},a=n.membership||{};s.innerHTML=`${d({title:"My Gym"})}
