import{a as p,z as m,b as g,k as $,e as c,D as r,I as t,S as u,u as a,N as l,n as y}from"./index-BNW__y8c.js";const S={async mount(s,o){const v=o?.campaignId;s.innerHTML=`${p({title:"Campaign",showBack:!0})}<div class="scroll-view" id="cd-scroll">${m()}</div>`,g(s,{onBack:()=>y.pop()});const n=await $(`/api/mobile/v1/campaigns/${v}`),d=s.querySelector("#cd-scroll");if(!n.ok){d.innerHTML='<div class="empty-state"><div class="empty-state-title">Campaign not found</div></div>';return}const e=n.data;d.innerHTML=`<div class="scroll-content">
