import{a as v,i as b,b as p,k as n,e as c,N as u,s as m,n as g}from"./index-B7qIMgpI.js";const f={async mount(s,d){const i=d?.conversationId;s.innerHTML=`${v({title:"Conversation",showBack:!0})}<div class="scroll-view" id="bcd-scroll"><div class="full-loader"><div class="spinner"></div></div></div>
