import{k as s,a as f,r as t,b as g,s as d,n as v,p as h}from"./index-BcPSQxV-.js";const q={async mount(e,p){const i=p?.memberId,o=await s(`/api/mobile/v1/members/${i}`);if(!o.ok){e.innerHTML='<div class="empty-state"><div class="empty-state-title">Member not found</div></div>';return}const a=o.data,m=await s("/api/mobile/v1/settings"),b=m.ok?m.data.plans||[]:[];e.innerHTML=`
