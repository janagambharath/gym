import{a as r,z as c,b as o,k as f,A as v,f as m,e as s,C as p,n as l}from"./index-ivBBLkG7.js";const y={async mount(e){e.innerHTML=`${r({title:"Staff",showBack:!0,actions:[{icon:"add",label:"Add"}]})}<div class="scroll-view" id="staff-list">${c()}</div>`,o(e,{onBack:()=>l.pop(),actions:[{onClick:()=>d()}]});const t=await f("/api/mobile/v1/staff"),i=t.ok?t.data.staff||t.data||[]:[],n=e.querySelector("#staff-list");if(!Array.isArray(i)||i.length===0){n.innerHTML=v({icon:"staff",title:"No staff",text:"Add your team members"});return}n.innerHTML=`<div class="scroll-content"><div class="card" style="margin:var(--sp-lg)">${i.map(a=>`
