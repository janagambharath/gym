import{a as o,z as d,b as l,k as v,A as c,i as u,e as n,O as b,D as m,n as r}from"./index-D6Fm9ZNQ.js";const h={async mount(a){a.innerHTML=`${o({title:"Conversations",showBack:!0})}<div class="scroll-view" id="bc-list">${d()}</div>`,l(a,{onBack:()=>r.pop()});const t=await v("/api/mobile/v1/bot/conversations"),s=a.querySelector("#bc-list"),i=t.ok?t.data.conversations||t.data||[]:[];if(!Array.isArray(i)||i.length===0){s.innerHTML=c({icon:"chatbubble",title:"No conversations",text:"Bot conversations will appear here"});return}s.innerHTML=`<div class="scroll-content"><div class="card" style="margin:var(--sp-lg)">${i.map(e=>`
