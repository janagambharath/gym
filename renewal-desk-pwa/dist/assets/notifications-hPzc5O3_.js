import{a as o,z as l,b as c,k as d,A as v,i as p,e as n,O as m,n as f}from"./index-B7qIMgpI.js";const y={async mount(a){a.innerHTML=`${o({title:"Notifications",showBack:!0})}<div class="scroll-view" id="nf-list">${l()}</div>`,c(a,{onBack:()=>f.pop()});const i=await d("/api/mobile/v1/notifications"),s=a.querySelector("#nf-list"),e=i.ok?i.data.notifications||i.data||[]:[];if(!Array.isArray(e)||e.length===0){s.innerHTML=v({icon:"notifications",title:"No notifications",text:"You're all caught up!"});return}s.innerHTML=`<div class="scroll-content"><div class="card" style="margin:var(--sp-lg)">${e.map(t=>{const r={payment:"wallet",renewal:"renewals",member:"person",whatsapp:"whatsapp",bot:"robot",campaign:"megaphone"}[t.type]||"notifications";return`<div class="list-item" style="${t.read?"":"background:var(--brand-subtle)"}">
