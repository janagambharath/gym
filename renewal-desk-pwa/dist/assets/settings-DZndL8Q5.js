const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DcA9rnoc.js","assets/index-BggJztOB.css"])))=>i.map(i=>d[i]);
import{a as v,f as p,e as i,C as g,D as e,i as m,b as u,n,E as o,p as r,_ as f,j as b,F as y}from"./index-DcA9rnoc.js";const w={async mount(a){const s=b();a.innerHTML=`
      ...
      </div></div>`,u(a,{onBack:()=>y.depth>1?n.pop():n.switchTab("dashboard")}),a.querySelectorAll("[data-action]").forEach(t=>{t.addEventListener("click",()=>n.push(t.dataset.action))}),a.querySelector("#btn-logout").addEventListener("click",async()=>{await o({title:"Sign Out",message:"Are you sure you want to sign out?",confirmText:"Sign Out"})&&r()}),a.querySelector("#btn-delete").addEventListener("click",async()=>{if(!await o({title:"Delete Account",message:"This will permanently delete your account and all gym data. This cannot be undone.",confirmText:"Delete Permanently",destructive:!0}))return;const{deleteAccount:c}=await f(async()=>{const{deleteAccount:l}=await import("./index-DcA9rnoc.js").then(d=>d.P);return{deleteAccount:l}},__vite__mapDeps([0,1]));await c(),r()})}};export{w as default};
