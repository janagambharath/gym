import{a as i,z as d,b as v,k as b,N as a,u as s,G as o,n as l}from"./index-1Q0YpctZ.js";const g={async mount(r){r.innerHTML=`${i({title:"AI Receptionist",showBack:!0})}<div class="scroll-view" id="bot-scroll">${d()}</div>`,v(r,{onBack:()=>l.pop()});const c=await b("/api/mobile/v1/bot/overview"),t=r.querySelector("#bot-scroll"),e=c.ok?c.data:{};t.innerHTML=`<div class="scroll-content">
  ...
  </div>`,t.querySelectorAll("[data-action]").forEach(n=>n.addEventListener("click",()=>l.push(n.dataset.action)))}};export{g as default};
