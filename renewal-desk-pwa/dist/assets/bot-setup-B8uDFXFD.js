import{k as o,a as i,r,b as n,s as u,n as c}from"./index-DBor-WEA.js";const b={async mount(e){const l=await o("/api/mobile/v1/bot/config"),a=l.ok?l.data:{};e.innerHTML=`${i({title:"Bot Setup",showBack:!0})}<div class="scroll-view"><div class="scroll-content" style="padding:var(--sp-xxl)">
