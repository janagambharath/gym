import{o as y,k as n,G as g,H as f,a as h,f as w,e as d,D as $,I as t,J as o,i,b as x,n as r,s as l,F as _,K as S}from"./index-BNW__y8c.js";const M={async mount(a,m){let e=m?.member?JSON.parse(m.member):null;if(!e){a.innerHTML=y("Member not found");return}const v=await n(`/api/mobile/v1/members/${e.id}`);v.ok&&(e=v.data);const c=g(e),b=S(c),p=f(e.days_until_expiry);a.innerHTML=`
