import{a as i,i as t,e as s,t as l,b as c,k as p,s as d,n as r}from"./index-1Q0YpctZ.js";const v={mount(n,o){const a=o||{};n.innerHTML=`${i({title:"Confirm Renewal",showBack:!0})}<div class="scroll-view"><div class="scroll-content" style="padding:var(--sp-xxl);text-align:center">
  ...
  </div></div>`,c(n,{onBack:()=>r.pop()}),n.querySelector("#fr-confirm")?.addEventListener("click",async()=>{const e=await p(`/api/mobile/v1/payments/${a.paymentId}/verify`,{method:"POST"});d(e.ok?"Renewal confirmed!":e.error.message,e.ok?"success":"error"),e.ok&&r.pop()})}};export{v as default};
