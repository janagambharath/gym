import{a as o,z as l,b as c,k as n,u as i,w as p,i as y,e as f,N as m,C as g,A as u,n as x}from"./index-B7qIMgpI.js";const b={async mount(t){t.innerHTML=`${o({title:"Access Control",showBack:!0})}<div class="scroll-view" id="ac-scroll">${l()}</div>`,c(t,{onBack:()=>x.pop()});const[r,a]=await Promise.all([n("/api/mobile/v1/access/status"),n("/api/mobile/v1/access/log?page_size=20")]),v=t.querySelector("#ac-scroll"),s=r.ok?r.data:{},d=a.ok?a.data.events||a.data.log||[]:[];v.innerHTML=`<div class="scroll-content">
