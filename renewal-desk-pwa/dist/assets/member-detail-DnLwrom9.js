import{o as u,k as n,y as g,v as f,a as h,f as w,e as d,x as $,F as t,w as o,i,b as x,n as r,s as l,E as _,I as S}from"./index-BcPSQxV-.js";const M={async mount(a,m){let e=m?.member?JSON.parse(m.member):null;if(!e){a.innerHTML=u("Member not found");return}const v=await n(`/api/mobile/v1/members/${e.id}`);v.ok&&(e=v.data);const c=g(e),b=S(c),p=f(e.days_until_expiry);a.innerHTML=`
