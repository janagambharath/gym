import{k as l,a as i,r as s,b as o,s as p,n as u}from"./index-ivBBLkG7.js";const d={async mount(e){const r=await l("/api/mobile/v1/settings"),t=r.ok?r.data.payment_settings||{}:{};e.innerHTML=`${i({title:"Payment Setup",showBack:!0})}<div class="scroll-view"><div class="scroll-content" style="padding:var(--sp-xxl)">
