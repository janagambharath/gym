import{k as o,a as p,b as y,v as c,C as f,I as t,J as b,N as $,i as l,s,n as r,E as v}from"./index-DcA9rnoc.js";const h={async mount(a,u){const i=u?.paymentId,m=await o(`/api/mobile/v1/payments/${i}`);if(!m.ok){a.innerHTML=`${p({title:"Payment",showBack:!0})}<div class="empty-state"><div class="empty-state-title">Payment not found</div></div>`,y(a,{onBack:()=>r.pop()});return}const e=m.data;a.innerHTML=`${p({title:"Payment Detail",showBack:!0})}
