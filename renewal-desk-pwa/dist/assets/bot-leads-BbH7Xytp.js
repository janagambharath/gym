import{a as n,z as l,b as o,k as c,A as v,f as m,e as d,O as p,D as u,n as r}from"./index-D6Fm9ZNQ.js";const $={async mount(a){a.innerHTML=`${n({title:"Leads",showBack:!0})}<div class="scroll-view" id="bl-list">${l()}</div>`,o(a,{onBack:()=>r.pop()});const t=await c("/api/mobile/v1/bot/leads"),s=a.querySelector("#bl-list"),i=t.ok?t.data.leads||t.data||[]:[];if(!Array.isArray(i)||i.length===0){s.innerHTML=v({icon:"target",title:"No leads yet",text:"Leads from bot conversations will appear here"});return}s.innerHTML=`<div class="scroll-content"><div class="card" style="margin:var(--sp-lg)">${i.map(e=>`
