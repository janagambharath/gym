import{a as p,e as r,i as m,b as v,k as c,s as l,n as d}from"./index-ivBBLkG7.js";const b={mount(s,i){const a=i?.members?JSON.parse(i.members):[];s.innerHTML=`${p({title:`Review (${a.length})`,showBack:!0})}<div class="scroll-view"><div class="scroll-content" style="padding:var(--sp-lg)">
