import{a as i,z as n,b as d,k as l,i as o,e as c,x as m,F as t,w as v,t as u,n as p}from"./index-BcPSQxV-.js";const g={async mount(s){s.innerHTML=`${i({title:"Subscription",showBack:!0})}<div class="scroll-view" id="sub-scroll">${n()}</div>`,d(s,{onBack:()=>p.pop()});const a=await l("/api/mobile/v1/billing"),r=s.querySelector("#sub-scroll");if(!a.ok){r.innerHTML='<div class="empty-state"><div class="empty-state-title">Could not load subscription</div></div>';return}const e=a.data;r.innerHTML=`<div class="scroll-content">
