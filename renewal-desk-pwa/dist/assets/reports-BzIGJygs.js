import{a as n,z as m,b as p,k as y,u as a,v as i,I as u,n as w}from"./index-DcA9rnoc.js";const b={async mount(s){s.innerHTML=`${n({title:"Reports",showBack:!0})}<div class="scroll-view" id="rpt-scroll">${m()}</div>`,p(s,{onBack:()=>w.pop()});const r=await y("/api/mobile/v1/reports/summary"),d=s.querySelector("#rpt-scroll");if(!r.ok){d.innerHTML=`<div class="empty-state"><div class="empty-state-title">Could not load reports</div><div class="empty-state-text">${r.error.message}</div></div>`;return}const e=r.data,t=(c,l)=>`<div style="padding:0 var(--sp-lg) var(--sp-lg)">
