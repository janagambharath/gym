import{k as d,a as m,A as v,e as y,v as b,i as p,b as f,n as g,E as $,s as u,r as c}from"./index-BPPTfp3n.js";const k={async mount(t){let l=[],a=null;async function o(){const e=await d("/api/mobile/v1/settings");l=e.ok?e.data.plans||[]:[],n()}function n(){t.innerHTML=`${m({title:"Membership Plans",showBack:!0,actions:[{icon:"add",label:"Add"}]})}
