import{a as m,z as p,i as u,b as g,n as o,k as y,p as b,o as h,v as L,u as f,A as x,y as $}from"./index-DBor-WEA.js";const z={async mount(e){let n=[],d=1,l=0,r="all";e.innerHTML=`
      ${m({title:"Payments",actions:[{icon:"add",label:"Record"}]})}
      ...
      </div>`,a.querySelectorAll("[data-payment-id]").forEach(t=>{t.addEventListener("click",()=>o.push("payment-detail",{paymentId:t.dataset.paymentId}))})}await c()}};export{z as default};
