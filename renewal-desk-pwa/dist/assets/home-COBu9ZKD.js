import{k as o,a as d,e as r,x as c,w as m,G as e,i as v,n as l}from"./index-1Q0YpctZ.js";const b={async mount(s){const i=await o("/api/member/v1/home"),n=i.ok?i.data:{},a=n.membership||{};s.innerHTML=`${d({title:"My Gym"})}
