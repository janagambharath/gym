import{a as r,z as o,b as l,k as d,A as c,f as v,e as n,O as m,n as p}from"./index-BNW__y8c.js";const f={async mount(s){s.innerHTML=`${r({title:"Inbox",showBack:!0})}<div class="scroll-view" id="ib-list">${o()}</div>`,l(s,{onBack:()=>p.pop()});const t=await d("/api/mobile/v1/inbox"),i=s.querySelector("#ib-list"),a=t.ok?t.data.messages||t.data||[]:[];if(!Array.isArray(a)||a.length===0){i.innerHTML=c({icon:"inbox",title:"Inbox empty",text:"No messages yet"});return}i.innerHTML=`<div class="scroll-content"><div class="card" style="margin:var(--sp-lg)">${a.map(e=>`
    <div class="list-item">
